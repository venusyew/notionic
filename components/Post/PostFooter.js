        ...
        <div className='flex flex-wrap gap-3'>
          {BLOG.showWeChatPay && (
            <button
              ...
              className='flex gap-1 bg-gray-200 dark:bg-neutral-600 hover:bg-neutral-300 dark:hover:bg-neutral-500 hover:text-neutral-600 dark:hover:text-neutral-300 text-sm rounded-lg px-4 py-2'
            >
          ...
          <button
            ...
            className='flex gap-1 bg-neutral-200 dark:bg-neutral-600 hover:bg-neutral-300 dark:hover:bg-neutral-500 hover:text-neutral-600 dark:hover:text-neutral-300 text-sm rounded-lg px-4 py-2'
          >
