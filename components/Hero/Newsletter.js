  ...
  return (
    <>
      <div className='container mx-auto flex px-5 py-2 mb-10 md:flex-row flex-col items-center'>
            ...
            <Link passHref href={BLOG.telegramChannelUrl} scroll={false} className='flex'>
              <button className='w-full bg-stone-100 dark:bg-stone-700 hover:bg-stone-200 dark:hover:bg-stone-600 inline-flex py-3 px-5 rounded-lg items-center'>
                <svg
                  ...
                  fill='currentColor'
                  className='text-neutral-600 dark:text-day w-7 h-7 mt-1'
                  viewBox='0 0 24 24'
                >
            ...
            {showCopied ? (
              ...
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
                  className='text-neutral-600 dark:text-day w-6 h-6'
                  viewBox='0 0 24 24'
                >
                  <path fill='none' d='M0 0h24v24H0z' />
        ...
        <div className='w-1/5'>
          <NewspaperIcon className='object-cover object-center text-neutral-500 dark:text-neutral-300' />
        </div>
      </div>
    </>
  )
